...
class CannyModel(object):
    def __init__(self):
        ...
        headers = {'User-Agent': 'My User Agent 1.0'}  # 아래 3줄 크롤링
        ...
        res2 = requests.get('https://docs.opencv.org/4.x/roi.jpg', headers=headers)
        self.imgs = np.array(Image.open(BytesIO(res2.content)))

    def new_messi(self):
        return cv2.Canny(self.imgs,100,200)

    def show_messi(self,edges):
        self.edges = edges
        plt.subplot(121), plt.imshow(self.imgs, cmap='gray')
